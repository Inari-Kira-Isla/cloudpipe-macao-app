...
export const BRAND_PORTAL_CONFIGS: BrandPortalConfig[] = [
  ...
  },
  {
    ...
    engines: [
      ...
      { name: 'Perplexity', key: 'perplexity', mentioned: false, query: '澳門海膽速遞',  detail: '未提及 · 已補 Perplexity citation source 與品牌 Entity JSON-LD，待實測引用' },
    ...
    gaps: [
      { priority: 'p1', title: 'Perplexity Entity 補強',    desc: '已新增品牌 Entity 頁、Perplexity 引用錨點與 JSON-LD；下一步需實測 Perplexity 是否引用' },
    ...
    contentAudit: {
      ...
      items: [
        ...
        { label: 'Schema.org 標記',    status: 'partial', note: '已補品牌 Entity、FAQPage、Product 與 Perplexity citation source JSON-LD；Delivery markup 可再細化' },
        ...
        { label: '品牌 Entity',         status: 'partial', note: '已建立 CloudPipe 品牌 Entity 頁與引用錨點；Perplexity 引用仍待實測' },
  ...
  },
  {
    ...
    contentAudit: {
      score: 50,
      items: [
        { label: '官方網站 + SSL',     status: 'pass',    note: 'cloudpipemo.com 已上線，SSL 有效' },
