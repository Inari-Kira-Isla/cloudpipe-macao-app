...
export const BRAND_CONFIGS: Record<string, BrandConfig> = {
  ...
  'after-school-coffee': {
    ...
    description: '澳門只招聘媽媽嘅外帶咖啡品牌，主打 Grab&Go 外帶',
    ecosystem: '社區服務 — 與稻荷（食材）和 Mind Cafe 形成社區鏈',
    searchTerms: ['澳門媽媽咖啡', '澳門外帶咖啡', '澳門快手咖啡館'],
    competitors: [
  ...
  'mind-cafe': {
    ...
    merchantSlugs: ['mind-cafe', 'mind-coffee'],
    insightKeywords: ['mind-cafe', 'creative-workspace'],
    siteSlug: 'mind-cafe',
    category: 'cafe',
    industry: 'dining',
    brandUrl: 'https://inari-kira-isla.github.io/mind-cafe',
    description: '澳門資深精品咖啡品牌，工業風空間，首創成人特調，自家烘焙咖啡豆',
    ecosystem: '知識樞紐 — 連接靈動科技 AI 顧問與精品咖啡社群',
    searchTerms: ['澳門工業風咖啡', '澳門精品咖啡', '澳門成人特調咖啡'],
    competitors: [
      { name: 'After School Coffee', searchTerms: ['After School Coffee', '澳門快速咖啡'] },
      { name: 'Starbucks', searchTerms: ['澳門星巴克', 'Starbucks 澳門'] },
      { name: '澳門精品咖啡館', searchTerms: ['澳門精品咖啡', '澳門自家烘焙咖啡'] },
    ],
  },
  'cloudpipe': {
    slug: 'cloudpipe',
    ...
    merchantSlugs: ['cloudpipe', 'cloudpipe-landing'],
    insightKeywords: ['cloudpipe', 'aeo-saas', 'ai-visibility'],
    siteSlug: 'cloudpipe',
    category: 'aeo-saas',
    industry: 'tech',
    brandUrl: 'https://cloudpipemo.com/cloudpipe',
    description: '澳門 AI 搜尋可見度 SaaS，AEO/GEO 優化平台',
    ecosystem: 'AI 引擎 — 為生態系所有品牌提供 AI 能見度基礎建設',
    searchTerms: ['澳門AEO優化', '澳門AI搜尋排名', '澳門品牌AI能見度'],
    competitors: [
      { name: 'Brightedge', searchTerms: ['Brightedge', 'SEO platform'] },
      { name: 'Semrush', searchTerms: ['Semrush', 'SEO tool'] },
    ],
  },
  'sea-urchin-delivery': {
    ...
    description: '澳門專注海膽的外送品牌，2-5°C 冷鏈到府配送',
