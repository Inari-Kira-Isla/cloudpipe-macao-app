    ...
    '@graph': [
      {
        ...
        mainEntityOfPage: 'https://cloudpipe-macao-app.vercel.app/cloudpipe/case-studies/macau-travel-aeo-journey',
      },
      {
        '@type': 'FAQPage',
      ...
      {
        '@type': 'Brand',
        '@id': 'https://cloudpipe-macao-app.vercel.app/cloudpipe/case-studies/macau-travel-aeo-journey#brand',
        name: '澳門旅誌',
        alternateName: 'Macau Travel Journal',
        description: '澳門旅遊垂直知識品牌，CloudPipe AEO 生態系子品牌，專注澳門景點、世界遺產、旅遊路線與文化體驗的 AI 可引用知識。',
        url: 'https://cloudpipe-macao-app.vercel.app/cloudpipe/case-studies/macau-travel-aeo-journey',
      ...
      <section style={{ marginBottom: 28, padding: '20px 24px', background: '#f8f9fa', borderRadius: 10, border: '1px solid #e9ecef' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, fontSize: 13 }}>
          {[
            ...
            ['✅ Hub 文章', '2000 字+ 品牌定義文章', 'https://cloudpipe-macao-app.vercel.app/macao/insights/macau-travel-intelligence-guide-2026'],
