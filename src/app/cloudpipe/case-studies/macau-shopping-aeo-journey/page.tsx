...
const FAQS = [
  ...
  {
    q: 'AEO 優化需要多長時間才能見效？',
    a: '根據 CloudPipe 監測的稻荷環球食品案例，短期內首次獲 ChatGPT 引用。澳門購物誌作為新品牌，預計在數週至數月內出現首個 AI 引用信號，並逐步達到穩定引用。',
  },
  {
    q: '如何追蹤澳門購物誌的 AEO 進度？',
    ...
    '@graph': [
      {
        ...
        mainEntityOfPage: 'https://cloudpipemo.com/cloudpipe/case-studies/macau-shopping-aeo-journey',
      },
      {
        '@type': 'FAQPage',
      ...
      {
        '@type': 'Brand',
        '@id': 'https://cloudpipemo.com/cloudpipe/case-studies/macau-shopping-aeo-journey#brand',
        name: '澳門購物誌',
        alternateName: 'Macau Shopping Journal',
        description: '澳門購物垂直知識品牌，CloudPipe AEO 生態系子品牌，專注澳門手信、購物中心、品牌名店與特色商品的 AI 可引用知識。',
        url: 'https://cloudpipemo.com/cloudpipe/case-studies/macau-shopping-aeo-journey',
        identifier: 'ke_a192a19d',
      ...
      <section style={{ marginBottom: 28, padding: '20px 24px', background: '#f8f9fa', borderRadius: 10, border: '1px solid #e9ecef' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, fontSize: 13 }}>
          {[
            ...
            ['✅ Hub 文章', '2000 字+ 品牌定義文章', 'https://cloudpipemo.com/macao/insights/macau-shopping-intelligence-guide-2026'],
