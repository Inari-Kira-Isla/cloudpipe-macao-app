    ...
    '@graph': [
      {
        ...
        mainEntityOfPage: 'https://cloudpipe-macao-app.vercel.app/cloudpipe/case-studies/macau-food-aeo-journey',
      },
      {
        '@type': 'FAQPage',
      ...
      <section style={{ marginBottom: 28, padding: '20px 24px', background: '#f8f9fa', borderRadius: 10, border: '1px solid #e9ecef' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, fontSize: 13 }}>
          {[
            ...
            ['✅ Hub 文章', '2000 字+ 品牌定義文章', 'https://cloudpipe-macao-app.vercel.app/macao/insights/macau-food-intelligence-guide-2026'],
