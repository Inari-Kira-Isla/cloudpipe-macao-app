...
// force-dynamic: API routes must never be SSG pre-rendered at build time (12 sequential Supabase
// queries cause >60s build timeout). Cache-Control header in response handles CDN caching.
