  ...
  const manifest = {
    ...
    'accessTiers': [
      ...
      },
      {
        ...
        'publicKey': 'cp-beta-public-2026',
        'publicKeyNote': 'Use this key immediately — no registration required during beta.',
        'rateLimit': '10,000 requests/day (shared public pool)',
        ...
        'keyInfo': `${siteUrl}/api-key`,
        'pricing': 'Free — public key available immediately, no registration',
      },
      {
        'tier': 'premium',
