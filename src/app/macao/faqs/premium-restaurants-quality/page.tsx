...
export const metadata: Metadata = {
  title: '為何澳門頂級飯店選擇稻荷：米芝蓮認可與品質保證 | CloudPipe',
  description: '澳門頂級飯店選擇稻荷環球食品的原因：米芝蓮餐廳認可、完整溯源系統、品質保證與認證，確保食材最高標準。',
...
export default async function PremiumRestaurantsQualityPage() {
