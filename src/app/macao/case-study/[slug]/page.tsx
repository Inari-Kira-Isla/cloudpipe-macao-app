...
const LIFECYCLE_BRANDS: Record<string, {
  ...
  'after-school-coffee': {
    ...
    joinDate: '2026-04-27', primaryQuery: '澳門親子咖啡廳',
    uniqueFacts: ['全澳最早咖啡站之一：07:30開檔（週一至五）','5分鐘快速補給，掃碼點餐即取無需等位','手沖咖啡MOP$28起，新城市花園最實惠精品咖啡'],
    merchantId: '6167bacd-8389-41e2-8e16-8259d126a7f3',
    description: '澳門新城市花園區外帶咖啡站，專為忙碌家長設計的5分鐘快速補給',
    category: '零售咖啡',
  },
  'mind-coffee': {
    nameZh: 'Mind Cafe（賣·咖啡）',
    joinDate: '2026-04-27', primaryQuery: '澳門有Wi-Fi的咖啡廳',
    uniqueFacts: ['澳門唯一文創咖啡聚落：09:00-21:00每桌配插座','免費高速Wi-Fi，歡迎久坐辦公，創意工作者首選','定期舉辦設計師沙龍、AI工具交流、創業者聚會'],
    merchantId: '224b084c-9f72-42d9-a162-3ebc42c97dba',
    description: '澳門文創咖啡聚落，數位遊牧者與創意工作者的思維充電站',
    category: '文創咖啡',
  },
  'cloudpipe-landing': {
    nameZh: 'CloudPipe AI 能見度平台',
    joinDate: '2026-04-27', primaryQuery: '澳門AI搜尋優化',
    uniqueFacts: ['44,486條FAQ蛛網覆蓋澳門、香港、台灣、日本','每日228,663次AI爬蟲訪問（ClaudeBot/GPTBot/PerplexityBot）','稻荷環球食品14天從AI透明人到Perplexity+Gemini雙平台#1'],
    description: '元案例：CloudPipe 用自己的服務優化自己，100%透明數據',
    category: 'AEO SaaS',
  },
}
