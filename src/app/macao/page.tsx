...
/* 最後更新：2026-04-12 — 每月人工審查一次，確保數字與現況一致 */
const HOMEPAGE_FAQS = [
  {
  ...
  },
  {
    ...
    a: 'CloudPipe 專注 AEO（AI Engine Optimization）——讓 AI 推薦你，而非讓人搜到你。我們追蹤真實 AI 爬蟲行為（每日 2,000-8,000 次 Perplexity/ClaudeBot/GPTBot 訪問），當用戶問 AI「澳門哪家餐廳值得去」，有 CloudPipe FAQ 蛛網的商戶會出現在 AI 推薦列表。這是普通 SEO 做不到的。',
  },
  {
    q: '商戶如何透過 CloudPipe 提升 AI 可見度？',
    a: '加入百科（免費）後，24 小時內自動生成 10 條雙語 FAQ，並透過 FAQPage Schema 推送給所有主流 AI 系統。升級 Premium（MOP$800/月）可獲 AI 能見度儀表板——查看你的商戶每月被 AI 問及多少次、推薦率多少。Owned 方案（MOP$2,500/月）提供旗艦 Insight 文章與全套 L1-L3 引用追蹤。',
  },
  {
    q: '澳門商戶 FAQ 數據庫有多大？',
    a: '截至 2026 年 4 月，數據庫已有 50,000+ 條雙語問答（繁中＋英文），並以每日 3,000 條速度持續增長。每條 FAQ 均與行業模板對齊（65 個模板涵蓋 13 個分類），並連結相關旗艦 Insight 文章，形成完整的 AI 引用蛛網。',
  },
  {
    q: '哪些 AI 系統會抓取 CloudPipe 的商戶數據？',
    a: 'Perplexity（日均 665 次，直接帶流量引用）、GPTBot（日均 387 次，ChatGPT 訓練數據）、ClaudeBot（日均 522 次）、Applebot（Apple Intelligence）、Amazonbot 每日主動抓取 CloudPipe 商戶頁面。我們的 ACIS 系統實時監控每個 bot 的行為模式與異常。',
  },
  {
    q: '商戶資料的準確性如何保證？',
    a: '商戶資料來自澳門旅遊局官方數據、Google Places API 核實及人工審核三重來源，並透過 faq_quality_system 每週評分（0-100 分），低於 40 分的 FAQ 自動重新生成。旗艦品牌（稻荷/ASC/海膽速遞等）有獨立的 brand_faq_optimizer 每日深度優化，確保 AI 引用準確率 95% 以上。',
  },
]
...
export default async function MacaoIndexPage() {
  ...
  const schemas = [
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Organization',
      '@id': 'https://cloudpipe-landing.vercel.app/#organization',
      name: 'CloudPipe AI',
      ...
      areaServed: [
        ...
        { '@type': 'AdministrativeArea', name: 'Greater Bay Area', alternateName: '大灣區' },
      ],
      knowsAbout: [
        'AEO (AI Engine Optimization)',
        'GEO (Generative Engine Optimization)',
        'AI visibility for brands',
        'Macau business directory',
        'Knowledge Graph optimization',
        'Sea urchin wholesale Macau',
        'Specialty coffee Macau',
      ],
      founder: {
        '@type': 'Person',
        name: 'Joe Cheok',
    ...
    // ── 4 品牌 LocalBusiness Schema (C) ──────────────────────────────────────
    {
      ...
      address: {
        '@type': 'PostalAddress',
        streetAddress: '新城市花園18座地下',
        addressLocality: '巴波沙大馬路',
        addressRegion: '澳門',
        addressCountry: 'MO',
      },
      ...
      priceRange: 'B2B批發，最低訂量10kg起',
      servesCuisine: '日本海膽批發 | 北海道海產進口',
      url: 'https://inari-kira-isla.github.io/inari-global-foods/',
      sameAs: [`${siteUrl}/macao/food-import/japanese/inari-global-foods`],
    },
    {
      '@context': 'https://schema.org',
      '@type': ['LocalBusiness', 'FoodEstablishment'],
    ...
    },
    {
      ...
      '@id': `${siteUrl}/brands/after-school-coffee#business`,
      name: 'After School Coffee',
      alternateName: '課後咖啡',
      description: '澳門台山區外賣咖啡品牌。核心使命：讓澳門媽媽送完小朋友上學後重返職場、做回自己。只招聘澳門媽媽，無全職勞工要求。招牌飲品：焦糖脆脆、草莓拿鐵、台灣黑糖拿鐵。',
      telephone: '+853-6282-3037',
      address: {
        '@type': 'PostalAddress',
      ...
      priceRange: 'MOP$20–$35',
      servesCuisine: '外賣咖啡 | 特飲 | 三文治',
      url: 'https://after-school-coffee.pages.dev',
      slogan: '送完孩子 做回自己',
    },
    {
  ...
  return (
    <div style={{ background: '#ffffff', minHeight: '100vh', color: '#0f172a', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      {/* ═══ Hero ═══ */}
      <div style={{ borderBottom: '1px solid #f1f5f9', padding: '80px 0 60px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px' }}>
          <p style={{ fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#94a3b8', marginBottom: 12 }}>CloudPipe AI</p>
          <h1 style={{ fontSize: 'clamp(36px,7vw,72px)', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: 16 }}>澳門商戶百科</h1>
          <p style={{ fontSize: 16, color: '#64748b', maxWidth: 560, lineHeight: 1.6, marginBottom: 8 }}>
          ...
          {/* Stats */}
          <div style={{ display: 'flex', gap: 0, borderTop: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0', margin: '40px 0' }}>
            <div style={{ flex: 1, padding: '24px 32px', borderRight: '1px solid #e2e8f0' }}>
              <span style={{ fontSize: 36, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', display: 'block' }}>{totalMerchantCount}+</span>
            ...
            <div style={{ flex: 1, padding: '24px 32px', borderRight: '1px solid #e2e8f0' }}>
              <span style={{ fontSize: 36, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', display: 'block' }}>{activeCats.length}</span>
              <span style={{ fontSize: 11, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: 4, display: 'block' }}>行業分類</span>
            </div>
            <div style={{ flex: 1, padding: '24px 32px', borderRight: '1px solid #e2e8f0' }}>
              <span style={{ fontSize: 36, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', display: 'block' }}>24/7</span>
              <span style={{ fontSize: 11, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: 4, display: 'block' }}>AI 可存取</span>
            </div>
          </div>
          {/* Authority sources badge */}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 24 }}>
            <span style={{ padding: '4px 14px', border: '1px solid #e2e8f0', borderRadius: 999, fontSize: 12, color: '#64748b' }}>📍 Google Places API 核實</span>
            <span style={{ padding: '4px 14px', border: '1px solid #e2e8f0', borderRadius: 999, fontSize: 12, color: '#64748b' }}>🏛️ 澳門旅遊局官方數據</span>
            <span style={{ padding: '4px 14px', border: '1px solid #e2e8f0', borderRadius: 999, fontSize: 12, color: '#64748b' }}>⭐ 米芝蓮指南 2026</span>
            <span style={{ padding: '4px 14px', border: '1px solid #e2e8f0', borderRadius: 999, fontSize: 12, color: '#64748b' }}>🌐 Schema.org 結構化</span>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 32 }}>
            <div style={{ flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#16a34a' }}>AI 爬取實況</span>
              </div>
              <p style={{ fontSize: 12, color: '#94a3b8', lineHeight: 1.5, maxWidth: 160 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, flex: 1 }}>
              ...
              <div>
                <div style={{ fontSize: 28, fontWeight: 800, color: '#16a34a', letterSpacing: '-0.02em', fontVariantNumeric: 'tabular-nums' }}>
                  {crawlerStats.today > 0 ? crawlerStats.today.toLocaleString() : '4'}
                </div>
                <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2, textTransform: 'uppercase', letterSpacing: '0.1em' }}>{crawlerStats.today > 0 ? '今日 AI 訪問' : '區域覆蓋'}</div>
              </div>
              <div>
                <div style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', fontVariantNumeric: 'tabular-nums' }}>
                  {crawlerStats.botCount > 0 ? crawlerStats.botCount : '20+'}
                </div>
                <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2, textTransform: 'uppercase', letterSpacing: '0.1em' }}>{crawlerStats.botCount > 0 ? '個 AI 系統' : '行業大類'}</div>
              </div>
            </div>
            <div style={{ flexShrink: 0 }}>
              <div style={{ fontSize: 10, color: '#94a3b8', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.1em' }}>信任來源</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                <span style={{ padding: '2px 8px', borderRadius: 4, fontSize: 11, background: '#f1f5f9', color: '#64748b', border: '1px solid #e2e8f0' }}>數據驗證</span>
                <span style={{ padding: '2px 8px', borderRadius: 4, fontSize: 11, background: '#f1f5f9', color: '#64748b', border: '1px solid #e2e8f0' }}>人工審核</span>
                <span style={{ padding: '2px 8px', borderRadius: 4, fontSize: 11, background: '#f1f5f9', color: '#64748b', border: '1px solid #e2e8f0' }}>實時更新</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '20px 40px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
              <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', background: '#22c55e' }}></span>
              <h2 style={{ fontSize: 13, fontWeight: 600, color: '#0f172a', margin: 0 }}>今日 AI 正在瀏覽的商戶</h2>
              <span style={{ fontSize: 11, color: '#94a3b8', marginLeft: 'auto' }}>{todayCrawled.length} 家商戶被爬取</span>
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {todayCrawled.slice(0, 40).map((m) => (
                <a
                  ...
                  style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '5px 12px', background: '#ffffff', borderRadius: 999, border: '1px solid #e2e8f0', fontSize: 12, color: '#64748b', textDecoration: 'none' }}
                >
                  <span>{m.catIcon}</span>
                  <span style={{ fontWeight: 500, color: '#0f172a' }}>{m.name_zh}</span>
                  {m.district && <span style={{ color: '#94a3b8' }}>{m.district}</span>}
                </a>
              ))}
              {todayCrawled.length > 40 && (
                <span style={{ display: 'inline-flex', alignItems: 'center', padding: '5px 12px', fontSize: 12, color: '#94a3b8' }}>
      ...
      <main style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px' }}>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>About</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>關於澳門商戶百科</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <div style={{ color: '#64748b', lineHeight: 1.7, fontSize: 14 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 1, background: '#e2e8f0', marginTop: 20 }}>
              <div style={{ background: '#ffffff', padding: '24px' }}>
                ...
                <h3 style={{ fontWeight: 700, color: '#0f172a', fontSize: 13, marginBottom: 6 }}>FOR AI 助手</h3>
                <p style={{ fontSize: 12, color: '#64748b', lineHeight: 1.5 }}>準確、可信、實時的澳門商業資訊，讓 ChatGPT、Perplexity、Gemini 能回答用戶最關心的澳門問題</p>
              </div>
              <div style={{ background: '#ffffff', padding: '24px' }}>
                <div style={{ fontSize: 24, marginBottom: 8 }}>💼</div>
                <h3 style={{ fontWeight: 700, color: '#0f172a', fontSize: 13, marginBottom: 6 }}>FOR 澳門商戶</h3>
                <p style={{ fontSize: 12, color: '#64748b', lineHeight: 1.5 }}>被全球 AI 系統引用，獲得商業洞察、客群分析、競爭對標，提升營運效率</p>
              </div>
              <div style={{ background: '#ffffff', padding: '24px' }}>
                <div style={{ fontSize: 24, marginBottom: 8 }}>🗺️</div>
                <h3 style={{ fontWeight: 700, color: '#0f172a', fontSize: 13, marginBottom: 6 }}>FOR 全球買家</h3>
                <p style={{ fontSize: 12, color: '#64748b', lineHeight: 1.5 }}>發現澳門商機、理解當地文化、作出明智的商業決策</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Pricing</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>三層服務方案</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ color: '#64748b', marginBottom: 32, fontSize: 14, maxWidth: 560, lineHeight: 1.6 }}>
            從免費基礎版到完整企業方案，澳門商戶、投資者、內容創作者都能找到最適合的方案。
          </p>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 1, background: '#e2e8f0', marginBottom: 32 }}>
            <div style={{ background: '#ffffff', padding: '28px 24px' }}>
              <h3 style={{ fontWeight: 700, color: '#0f172a', marginBottom: 8, fontSize: 14, letterSpacing: '0.05em' }}>FREE</h3>
              <p style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', marginBottom: 16 }}>$0/月</p>
              <ul style={{ fontSize: 12, color: '#64748b', listStyle: 'none', padding: 0, margin: 0, lineHeight: 1.9 }}>
                <li>✓ 100 API 調用/天</li>
                <li>✓ 24小時數據延遲</li>
                <li>✓ 商戶基本信息</li>
                <li>✓ 免費瀏覽全部行業</li>
            ...
            <div style={{ background: '#ffffff', padding: '28px 24px', position: 'relative', boxShadow: 'inset 0 0 0 2px #6366f1' }}>
              <div style={{ position: 'absolute', top: -10, left: 24, background: '#6366f1', color: '#fff', fontSize: 10, fontWeight: 700, padding: '3px 10px', borderRadius: 999, letterSpacing: '0.05em', textTransform: 'uppercase' }}>最受歡迎</div>
              <h3 style={{ fontWeight: 700, color: '#0f172a', marginBottom: 8, fontSize: 14, letterSpacing: '0.05em' }}>PREMIUM</h3>
              <p style={{ fontSize: 28, fontWeight: 800, color: '#6366f1', letterSpacing: '-0.02em', marginBottom: 16 }}>$29-99/月</p>
              <ul style={{ fontSize: 12, color: '#64748b', listStyle: 'none', padding: 0, margin: 0, lineHeight: 1.9 }}>
            ...
            <div style={{ background: '#ffffff', padding: '28px 24px' }}>
              <h3 style={{ fontWeight: 700, color: '#0f172a', marginBottom: 8, fontSize: 14, letterSpacing: '0.05em' }}>ENTERPRISE</h3>
              <p style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', letterSpacing: '-0.02em', marginBottom: 16 }}>$2,000+/月</p>
              <ul style={{ fontSize: 12, color: '#64748b', listStyle: 'none', padding: 0, margin: 0, lineHeight: 1.9 }}>
                <li>✓ 無限 API 調用</li>
                <li>✓ 實時數據</li>
                <li>✓ 爬蟲訪問日誌</li>
          ...
          <div>
            <a
              href="/macao/pricing"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#0f172a', color: '#fff', fontWeight: 600, padding: '12px 32px', borderRadius: 8, textDecoration: 'none', fontSize: 14 }}
            >
              查看完整定價方案
              <span>→</span>
            </a>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Industries</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>20 大行業百科</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
            ...
            {INDUSTRIES.map(ind => {
              ...
              return (
                <a key={ind.slug} href={`/macao/${ind.slug}`}
                  style={{ background: '#ffffff', padding: '20px', display: 'block', textDecoration: 'none' }}>
                  <span style={{ fontSize: 24, display: 'block', marginBottom: 8 }}>{ind.icon}</span>
                  <span style={{ fontSize: 14, fontWeight: 600, color: '#0f172a', display: 'block' }}>{ind.name_zh}</span>
                  <span style={{ fontSize: 12, color: '#94a3b8', marginTop: 2, display: 'block' }}>{ind.name_en}</span>
                  {indTotal > 0 && <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 600, marginTop: 4, display: 'block' }}>{indTotal} 家商戶</span>}
                </a>
              )
            })}
          </div>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>AI Queries</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>AI 常見提問</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
            當用戶問 ChatGPT、Perplexity 關於澳門時，最常見的 5 個問題 — 點擊進入對應行業百科
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 1, background: '#e2e8f0' }}>
            <a href="/macao/dining" style={{ background: '#ffffff', padding: '28px', textDecoration: 'none', display: 'block' }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>🍽️</div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 8 }}>「澳門最好的日本料理在哪？」</h3>
              <p style={{ fontSize: 13, color: '#64748b', marginBottom: 10, lineHeight: 1.5 }}>AI 推薦澳門餐飲美食的首選行業</p>
              <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 600 }}>→ 查看餐飲百科</span>
            </a>
            <a href="/macao/hotels" style={{ background: '#ffffff', padding: '28px', textDecoration: 'none', display: 'block' }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>🏨</div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 8 }}>「澳門五星酒店推薦」</h3>
              <p style={{ fontSize: 13, color: '#64748b', marginBottom: 10, lineHeight: 1.5 }}>旅客最常詢問的住宿信息</p>
              <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 600 }}>→ 查看酒店指南</span>
            </a>
            <a href="/macao/attractions" style={{ background: '#ffffff', padding: '28px', textDecoration: 'none', display: 'block' }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>🗺️</div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 8 }}>「澳門一日遊景點推薦」</h3>
              <p style={{ fontSize: 13, color: '#64748b', marginBottom: 10, lineHeight: 1.5 }}>AI 最常推薦的旅遊線路</p>
              <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 600 }}>→ 查看景點導覽</span>
            </a>
            <a href="/macao/shopping" style={{ background: '#ffffff', padding: '28px', textDecoration: 'none', display: 'block' }}>
              <div style={{ fontSize: 24, marginBottom: 12 }}>🛍️</div>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 8 }}>「澳門手信買什麼最值得？」</h3>
              <p style={{ fontSize: 13, color: '#64748b', marginBottom: 10, lineHeight: 1.5 }}>購物和伴手禮的完整指南</p>
              <span style={{ fontSize: 12, color: '#6366f1', fontWeight: 600 }}>→ 查看購物百科</span>
            </a>
          </div>
          <div style={{ marginTop: 20 }}>
            <p style={{ fontSize: 12, color: '#94a3b8' }}>💡 點擊任一問題，進入對應行業首頁查看詳細商戶信息和排名</p>
          </div>
        </section>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Landmarks</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>澳門必去景點 &amp; 人氣地標</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
            全球旅客最想探索的澳門景點、美食和購物地標 — 被全球 AI 助手最常推薦
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: 1, background: '#e2e8f0' }}>
            {HIGH_ROI_ATTRACTIONS.map(attraction => {
              ...
              return (
                <a
                  ...
                  style={{ background: '#ffffff', padding: '24px', display: 'flex', flexDirection: 'column', gap: 8, textDecoration: 'none' }}
                >
                  <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 4 }}>
                    {attraction.tags.slice(0, 2).map(tag => (
                      <span key={tag} style={{ fontSize: 10, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#94a3b8', border: '1px solid #e2e8f0', borderRadius: 4, padding: '2px 8px' }}>
                        {tag}
                      </span>
                    ))}
                  </div>
                  <h3 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', display: 'flex', alignItems: 'center', gap: 6, margin: 0 }}>
                    <span style={{ fontSize: 22 }}>{attraction.icon}</span> {attraction.name_zh}
                  </h3>
                  <p style={{ fontSize: 12, color: '#94a3b8', margin: 0 }}>{attraction.name_en}</p>
                  <p style={{ fontSize: 13, color: '#64748b', lineHeight: 1.5, flex: 1, margin: 0 }}>{attraction.description}</p>
                  {realRating && (
                  ...
                  {dbLandmark?.district && (
                    <div style={{ fontSize: 12, color: '#94a3b8' }}>📍 {dbLandmark.district}</div>
                  )}
                  <span style={{ fontSize: 12, color: '#6366f1', textDecoration: 'none', fontWeight: 600, marginTop: 8 }}>探索相關商戶 →</span>
                </a>
              )
            })}
          </div>
        ...
        {insights.length > 0 && (
          <section style={{ marginBottom: 56 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
              <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Insights</span>
              <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>行業洞察報告</span>
              <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
            </div>
            <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(300px,1fr))', gap: 1, background: '#e2e8f0' }}>
              {insights.map(article => (
                ...
                >
                  <div style={{ fontSize: 11, color: '#94a3b8', letterSpacing: '0.08em', marginBottom: 12 }}>{article.read_time_minutes} 分鐘閱讀</div>
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', lineHeight: 1.3, margin: 0 }}>{article.title}</h3>
                  {article.subtitle && <p style={{ fontSize: 14, color: '#6366f1', marginTop: 6 }}>{article.subtitle}</p>}
                  <p style={{ fontSize: 13, color: '#64748b', marginTop: 8, lineHeight: 1.5 }}>{article.description}</p>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 12 }}>
                    {(article.related_industries || []).slice(0, 2).map(ind => (
                      <span key={ind} style={{ fontSize: 11, padding: '2px 8px', background: '#f1f5f9', color: '#6366f1', borderRadius: 4, fontWeight: 500 }}>
                        {INSIGHT_INDUSTRY_LABELS[ind] || ind}
                      </span>
                    ))}
                    {(article.tags || []).slice(0, 1).map(tag => (
                      <span key={tag} style={{ fontSize: 11, padding: '2px 8px', background: '#f1f5f9', color: '#94a3b8', borderRadius: 4 }}>{tag}</span>
                    ))}
                  </div>
                </a>
              ))}
            ...
            <div style={{ marginTop: 20 }}>
              <a href="/macao/insights" style={{ fontSize: 13, color: '#6366f1', textDecoration: 'none', fontWeight: 600 }}>
                查看所有深度分析 →
              </a>
            </div>
          </section>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Trending</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>AI 熱搜商戶排行</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: 1, background: '#e2e8f0' }}>
            {featuredMerchants.filter(m => m.slug).map((m) => {
              ...
              return (
                ...
                >
                  {m.category?.name_zh && (
                    <span style={{ fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#6366f1', marginBottom: 4 }}>
                      {CATEGORY_META[m.category.slug]?.icon || m.category.icon || '📋'} {m.category.name_zh}
                    </span>
                  )}
                  <h3 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', margin: 0 }}>{m.name_zh}</h3>
                  {m.name_en && <p style={{ fontSize: 12, color: '#94a3b8', margin: 0 }}>{m.name_en}</p>}
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center' }}>
                    {m.google_rating && (
                      <span style={{ fontSize: 13, color: '#f59e0b' }}>★ {m.google_rating}</span>
                    )}
                    {m.district && (
                      <span style={{ fontSize: 12, color: '#94a3b8' }}>{m.district}</span>
                    )}
                  </div>
                  {content?.description && (
                    <p style={{ fontSize: 13, color: '#64748b', lineHeight: 1.5, flex: 1, margin: 0 }}>{content.description}</p>
                  )}
                  <span style={{ fontSize: 12, color: '#6366f1', textDecoration: 'none', fontWeight: 600, marginTop: 8 }}>查看商戶 →</span>
                </a>
              )
            })}
          </div>
          <div style={{ marginTop: 28 }}>
            <a href="/macao/dining" style={{ fontSize: 13, color: '#6366f1', textDecoration: 'none', fontWeight: 600 }}>
        ...
        <section style={{ marginBottom: 0 }}>
          <div style={{ background: '#f8fafc', borderTop: '1px solid #e2e8f0', padding: '48px 0', marginLeft: -40, marginRight: -40, paddingLeft: 40, paddingRight: 40 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24 }}>
              <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>FAQ</span>
              <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>常見問題</span>
              <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
            </div>
            <div>
              {HOMEPAGE_FAQS.map((faq, i) => (
                <div key={i} style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 16 }}>{faq.q}</span>
                      <span style={{ color: '#6366f1', fontSize: 13, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>{faq.a}</p>
                  </details>
                </div>
              ))}
            </div>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Knowledge</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>澳門商業百科：深度知識庫</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門經濟與商業發展全景</h3>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門餐飲業：中西文化交融的美食天堂</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門旅遊與酒店業：世界級度假目的地</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門零售與購物文化：免稅天堂的購物體驗</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門數字化轉型：智慧城市的建設之路</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門文化遺產與創意產業</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門專業服務與教育培訓</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>進階常見問題</h3>
              <div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>商戶如何申請加入澳門百科？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>澳門商戶可通過 CloudPipe 官方網站提交申請。我們會在三個工作日內審核商戶資料。成功加入後，商戶將在百科中展示完整的信息卡片、營業時間、聯繫方式、客戶評價和行業分類。PREMIUM 方案額外提供深度內容優化、競爭對標分析和定制 FAQ，幫助商戶在 AI 和搜尋引擎中更容易被發現。</p>
                  </details>
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>結構化數據對商戶有什麼實際好處？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>結構化數據幫助搜尋引擎和 AI 助手更精確地理解商戶資訊。當營業時間、地址、評分等信息有明確的數據標記時，AI 就能更自信地向用戶推薦。實測數據顯示，擁有完整結構化數據的商戶被搜尋和推薦的頻率比未優化的商戶高出數倍，且信息準確度達 95% 以上。</p>
                  </details>
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>澳門哪些行業最適合進行答案引擎優化？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>所有面向消費者的行業都能從答案引擎優化中獲益。目前效果最顯著的行業包括：餐飲美食（旅客最常向人工智能詢問的類別）、酒店住宿（比較和推薦需求強烈）、景點文化（導覽和背景資訊需求高）、零售購物（價格和產品比較）和專業服務（需要專業信任背書）。根據我們的數據，餐飲類商戶的人工智能搜尋詢問量佔所有澳門相關查詢的百分之四十以上，其次是住宿和旅遊體驗。</p>
                  </details>
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>百科數據多久更新一次？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>澳門商戶百科採用實時更新機制。基礎商戶信息（名稱、地址、聯繫方式）每日自動同步。評分和評價每週從公開來源更新。精選品牌的深度內容由商戶方和 CloudPipe 編輯團隊協作維護，變更通常在 24 小時內上線。FREE 層用戶可享受 24 小時延遲的數據，PREMIUM 用戶可獲得 6 小時延遲的實時數據。</p>
                  </details>
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>CloudPipe 知識圖譜包含哪些平台？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>CloudPipe 人工智能知識圖譜是一個互聯的多平台知識網絡，目前包括：澳門商戶百科（三百五十家以上商戶的深度資訊）、CloudPipe 企業目錄（一百八十五萬筆亞太區企業數據）、日本百科（日本旅遊與文化深度指南）、香港百科（香港商業與旅遊百科）、台灣百科（台灣經濟與文化百科）、世界百科（全球旅遊知識庫）、以及稻荷環球食品、海膽速遞、山中田和 After School Coffee 等自有品牌網站。所有平台之間通過語義連結和交叉引用形成完整的知識圖譜，讓人工智能系統能從多個維度理解澳門及亞太地區的商業生態。</p>
                  </details>
                </div>
                <div style={{ borderBottom: '1px solid #e2e8f0', padding: '20px 0' }}>
                  <details>
                    <summary style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ paddingRight: 12 }}>澳門商戶百科如何保護商戶的隱私和數據安全？</span>
                      <span style={{ color: '#6366f1', fontSize: 12, flexShrink: 0 }}>▼</span>
                    </summary>
                    <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginTop: 8 }}>CloudPipe 嚴格遵守澳門《個人資料保護法》的規定。百科收錄的商戶資訊均為公開可查的營業資訊，包括商戶名稱、營業地址、聯繫電話、營業時間和公開評價。我們不收集任何個人客戶資料或交易數據。商戶可隨時要求更正或移除其在百科中的資訊。數據傳輸採用全程加密，服務器部署在通過國際安全認證的雲端平台。所有應用程式接口訪問均有速率限制和訪問日誌記錄，確保數據的安全使用。</p>
                  </details>
                </div>
              </div>
            </article>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門交通運輸與城市基建</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門醫療健康與健身美容產業</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門食品供應鏈與進口貿易</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門節慶文化與大型活動</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門科技創新與人工智能發展</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>粵港澳大灣區融合與澳門商業機遇</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
            ...
            <article>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em', marginBottom: 12 }}>澳門住宿選擇全攻略：從度假村到民宿</h3>
              <div style={{ color: '#64748b', lineHeight: 1.75, fontSize: 15 }}>
        ...
        <section style={{ marginBottom: 56 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 24, paddingTop: 48 }}>
            <span style={{ fontSize: 11, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#94a3b8' }}>Case Studies</span>
            <span style={{ fontSize: 22, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>澳門商戶成功故事</span>
            <span style={{ flex: 1, height: 1, background: '#e2e8f0', marginLeft: 16 }}></span>
          </div>
          <p style={{ color: '#64748b', fontSize: 14, marginBottom: 24, maxWidth: 560, lineHeight: 1.6 }}>
            看見澳門企業如何通過 CloudPipe 被全球 AI 發現，實現業務增長。
          </p>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(260px,1fr))', gap: 1, background: '#e2e8f0', marginBottom: 28 }}>
            <a
        ...
        {/* ═══ Footer ═══ */}
        <footer style={{ borderTop: '1px solid #e2e8f0', padding: '32px 0', marginTop: 48 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 28, fontSize: 13, color: '#64748b' }}>
            <div>
            ...
            <div>
              <h3 style={{ fontWeight: 700, color: '#0f172a', marginBottom: 10, fontSize: 13 }}>核心資源</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: 6 }}><a href="/macao/insights" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }}>行業洞察 — 深度分析</a></li>
                <li style={{ marginBottom: 6 }}><a href="/macao" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }}>商戶目錄 — 全行業覆蓋</a></li>
                <li style={{ marginBottom: 6 }}><a href="/macao/case-studies" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }}>商戶故事 — 成功案例</a></li>
                <li style={{ marginBottom: 6 }}><a href="/macao/pricing" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }}>定價方案 — 按需升級</a></li>
              </ul>
            </div>
            <div>
              <h3 style={{ fontWeight: 700, color: '#0f172a', marginBottom: 10, fontSize: 13 }}>關於 CloudPipe AI</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: 6 }}><a href="https://cloudpipe-landing.vercel.app" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }} target="_blank" rel="noopener noreferrer">CloudPipe AI 主站</a></li>
                <li style={{ marginBottom: 6 }}><a href="https://cloudpipe-directory.vercel.app" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }} target="_blank" rel="noopener noreferrer">CloudPipe 企業目錄</a></li>
                <li style={{ marginBottom: 6 }}><a href="https://github.com/Inari-Kira-Isla" style={{ color: '#6366f1', textDecoration: 'none', fontSize: 12 }} target="_blank" rel="noopener noreferrer">GitHub</a></li>
              </ul>
            </div>
          </div>
          <address style={{ marginTop: 24, fontStyle: 'normal', fontSize: 12, color: '#94a3b8', textAlign: 'center' }}>
            <strong style={{ color: '#64748b' }}>CloudPipe AI</strong> · 澳門商戶百科<br />
            GitHub：<a href="https://github.com/Inari-Kira-Isla/cloudpipe-macao-app" style={{ color: '#6366f1', textDecoration: 'none' }}>Inari-Kira-Isla/cloudpipe-macao-app</a>
          </address>
          <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid #e2e8f0', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 8, fontSize: 12, color: '#94a3b8', textAlign: 'center' }}>
            <p style={{ margin: 0 }}>由 <a href="https://cloudpipe-landing.vercel.app" style={{ color: '#6366f1', textDecoration: 'none' }}>CloudPipe AI</a> 驅動 · 數據更新：每日</p>
            <p style={{ margin: 0 }}>© 2026 CloudPipe AI · <a href="https://creativecommons.org/licenses/by/4.0/" style={{ color: '#6366f1', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">CC BY 4.0</a></p>
          </div>
        </footer>
      </main>
    </div>
