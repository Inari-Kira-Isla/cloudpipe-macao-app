...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('GLOBAL', { params, langOverride: 'pt' })
}

export default async function GlobalInsightPtPage({ params }: PageProps) {
  return renderInsightPage('GLOBAL', { params, langOverride: 'pt' })
}
