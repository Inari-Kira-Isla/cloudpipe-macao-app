...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('GLOBAL', { params, langOverride: 'ja' })
}

export default async function GlobalInsightJaPage({ params }: PageProps) {
  return renderInsightPage('GLOBAL', { params, langOverride: 'ja' })
}
