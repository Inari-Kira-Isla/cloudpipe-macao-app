...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('GLOBAL', { params, langOverride: 'ms' })
}

export default async function GlobalInsightMsPage({ params }: PageProps) {
  return renderInsightPage('GLOBAL', { params, langOverride: 'ms' })
}
