...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('GLOBAL', { params, langOverride: 'en' })
}

export default async function GlobalInsightEnPage({ params }: PageProps) {
  return renderInsightPage('GLOBAL', { params, langOverride: 'en' })
}
