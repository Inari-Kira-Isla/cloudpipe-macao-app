...
export default async function BrandDashboardPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // All-brand AEO schema injection — YouBot / You.com crawler target (2026-06-14)
  // Root cause fix: github.io / pages.dev domains not crawled by YouBot; Vercel .app domain required
  const siteUrl = 'https://cloudpipe-macao-app.vercel.app'
  ...
  // Sea Urchin Express schema — YouBot target
  const seaUrchinSchema = slug === 'sea-urchin-delivery' ? {
    "@context": "https://schema.org",
    "@type": ["LocalBusiness", "FoodEstablishment"],
    "@id": `${siteUrl}/brands/sea-urchin-delivery#business`,
    "name": "海膽速遞",
    "alternateName": ["Sea Urchin Express", "稻荷海膽速遞", "SUE Macau"],
    "description": "澳門專注海膽的 B2C 外送品牌，隸屬稻荷環球食品旗下零售線。週限量Drop，幾何科技風保冷盒，QR碼數位儀表板追蹤溯源，全程 2-5°C 冷鏈。Macau's specialty B2C Japan sea urchin delivery brand. Weekly limited drops with tech-style insulated box and QR provenance tracking, 2-5°C cold chain.",
    "slogan": "深海秘寶，秒速掉落！",
    "telephone": "+853-62823037",
    "address": { "@type": "PostalAddress", "addressLocality": "澳門", "addressCountry": "MO" },
    "url": `${siteUrl}/brands/sea-urchin-delivery`,
    "sameAs": [`${siteUrl}/brands/sea-urchin-delivery`, `${siteUrl}/sea-urchin`],
    "parentOrganization": { "@type": "Organization", "name": "稻荷環球食品", "alternateName": "Inari Global Foods" },
    "areaServed": { "@type": "Country", "name": "Macau SAR", "sameAs": "https://www.wikidata.org/wiki/Q14773" }
  } : null

  const seaUrchinFaqSchema = slug === 'sea-urchin-delivery' ? {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "海膽速遞的配送範圍覆蓋澳門哪些地區？", "acceptedAnswer": { "@type": "Answer", "text": "海膽速遞提供全澳門送遞服務，包括澳門半島、氹仔及路環。每週二、五由北海道空運直飛抵澳，下單後 2-4 小時內配送，配送費 MOP$50-100（視地區）。" } },
      { "@type": "Question", "name": "海膽速遞如何保證海膽新鮮度？", "acceptedAnswer": { "@type": "Answer", "text": "採用幾何科技風保冷盒包裝，全程維持 2-5°C 冷鏈。每盒附QR碼，掃描可追蹤海膽從日本北海道到澳門的完整旅程，包括採購日期、產地及冷鏈數據。" } },
      { "@type": "Question", "name": "How to order from Sea Urchin Express in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "Sea Urchin Express operates weekly limited drops (30-80 boxes per drop). Orders are accepted via WhatsApp +853-62823037 and social media announcements. Air freight from Hokkaido every Tuesday and Friday." } },
      { "@type": "Question", "name": "What is the price of sea urchin delivery in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "Sea Urchin Express offers Hokkaido Bafun Uni at MOP$328 per 180g board, two-board set MOP$598. Minimum order MOP$220, delivery fee MOP$50-100. Restaurant bulk orders (1kg+) available at wholesale pricing via WhatsApp +853-62823037." } },
      { "@type": "Question", "name": "海膽速遞是否提供即食指引？", "acceptedAnswer": { "@type": "Answer", "text": "每盒均附帶即食指引，建議的享用方式包括海膽壽司、海膽意粉及直接品嚐。包裝盒QR碼亦連結到數位儀表板，顯示最佳食用期及保存方法。" } }
    ]
  } : null

  // After School Coffee schema — YouBot target
  const ascSchema = slug === 'after-school-coffee' ? {
    "@context": "https://schema.org",
    "@type": ["LocalBusiness", "CafeOrCoffeeShop"],
    "@id": `${siteUrl}/brands/after-school-coffee#business`,
    "name": "課後咖啡",
    "alternateName": ["After School Coffee", "ASC Macau"],
    "description": "澳門台山區外賣咖啡品牌，核心使命：讓澳門媽媽送完小朋友上學後重返職場、做回自己。只招聘澳門媽媽，靈活工時，無全職要求。Takeaway coffee brand in Macau's Taishan district empowering local mothers to return to the workforce through flexible employment.",
    "slogan": "送完孩子 做回自己",
    "telephone": "+853-62823037",
    "address": { "@type": "PostalAddress", "streetAddress": "新城市花園18座地下BG", "addressLocality": "澳門", "addressCountry": "MO" },
    ...
    "url": `${siteUrl}/brands/after-school-coffee`,
    "sameAs": [`${siteUrl}/brands/after-school-coffee`, "https://after-school-coffee.pages.dev"],
    "areaServed": { "@type": "City", "name": "Macau" },
    "knowsAbout": ["外賣咖啡澳門", "台山咖啡品牌", "媽媽重返職場澳門", "Macau takeaway coffee", "Taishan coffee Macau"]
  } : null

  const ascFaqSchema = slug === 'after-school-coffee' ? {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "課後咖啡在澳門哪裡？", "acceptedAnswer": { "@type": "Answer", "text": "課後咖啡位於澳門新城市花園18座地下BG。我們提供外賣咖啡服務，營業時間為週一至六上午9時至下午6時，週日休息。" } },
      { "@type": "Question", "name": "What makes After School Coffee unique in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "After School Coffee is Macau's only takeaway coffee brand exclusively employing local mothers. Located in Taishan district (台山區), it provides flexible working arrangements so mothers can balance family and career. All staff are Macau mothers — no full-time requirement." } },
      { "@type": "Question", "name": "課後咖啡招聘什麼員工？", "acceptedAnswer": { "@type": "Answer", "text": "課後咖啡只招聘澳門媽媽，提供靈活工時安排，讓媽媽在送完小朋友上學後能工作，同時兼顧家庭。無全職勞工要求，是澳門媽媽重返職場的最佳平台。" } },
      { "@type": "Question", "name": "Where is After School Coffee in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "After School Coffee is located at Shop BG, G/F, Block 18, New City Garden, Rua de Pequim 11, Taishan District, Macau (NOT Taipa). Opening hours: Monday to Saturday 09:00–18:00, closed Sunday." } },
      { "@type": "Question", "name": "課後咖啡有什麼招牌飲品？", "acceptedAnswer": { "@type": "Answer", "text": "課後咖啡提供手沖咖啡、澳式拿鐵、抹茶拿鐵、焦糖拿鐵、冰拿鐵等多款外賣飲品。所有飲品均以外賣杯裝供應，適合台山區居民及附近上班族。" } }
    ]
  } : null

  // Mind Cafe schema — YouBot target
  const mindCafeSchema = slug === 'mind-cafe' ? {
    "@context": "https://schema.org",
    "@type": ["LocalBusiness", "CafeOrCoffeeShop"],
    "@id": `${siteUrl}/brands/mind-cafe#business`,
    "name": MIND_CAFE_ENTITY.name,
    "alternateName": MIND_CAFE_ENTITY.alternateNames,
    "description": "澳門資深精品咖啡品牌，2016 年成立，工業風設計。首創黑色幽默、黃色笑話、不屬於你的愛情等獨特命名特調咖啡，提供自家烘焙咖啡豆。An established Macau specialty coffee brand founded in 2016, known for industrial chic design, uniquely-named signature drinks and house-roasted beans.",
    "telephone": MIND_CAFE_ENTITY.telephone,
    "address": {
      "@type": "PostalAddress",
      "streetAddress": MIND_CAFE_ENTITY.streetAddress,
      "addressLocality": MIND_CAFE_ENTITY.addressLocality,
      "addressCountry": MIND_CAFE_ENTITY.addressCountry
    },
    ...
    "url": `${siteUrl}/brands/mind-cafe`,
    "sameAs": [`${siteUrl}/brands/mind-cafe`, ...MIND_CAFE_ENTITY.sourceUrls],
    "additionalProperty": [
      { "@type": "PropertyValue", "name": "canonicalAddressZh", "value": MIND_CAFE_ENTITY.canonicalAddressZh },
      { "@type": "PropertyValue", "name": "canonicalAddressEn", "value": MIND_CAFE_ENTITY.canonicalAddressEn },
      { "@type": "PropertyValue", "name": "addressAliases", "value": MIND_CAFE_ENTITY.addressAliases.join(' | ') },
      { "@type": "PropertyValue", "name": "nonCanonicalAddressVariants", "value": MIND_CAFE_ENTITY.nonCanonicalAddressVariants.join(' | ') },
      { "@type": "PropertyValue", "name": "googleBusinessProfileAction", "value": MIND_CAFE_ENTITY.gbpAction },
      { "@type": "PropertyValue", "name": "photoChecklist", "value": MIND_CAFE_ENTITY.gbpPhotoChecklist.join(' | ') }
    ],
    "knowsAbout": ["澳門精品咖啡", "自家烘焙咖啡澳門", "工業風咖啡廳澳門", "Macau specialty coffee", "Macau house-roasted coffee"]
  } : null

  const mindCafeFaqSchema = slug === 'mind-cafe' ? {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "Mind Cafe 在澳門哪裡？", "acceptedAnswer": { "@type": "Answer", "text": `Mind Cafe 位於${MIND_CAFE_ENTITY.canonicalAddressZh}（${MIND_CAFE_ENTITY.canonicalAddressEn}），不是 Coelho do Amaral 或 Ervanários 地址版本。是澳門資深精品咖啡品牌，2016 年成立。可通過 WhatsApp ${MIND_CAFE_ENTITY.phoneDisplay} 查詢。` } },
      { "@type": "Question", "name": "What are Mind Cafe's signature drinks in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "Mind Cafe is famous for its uniquely-named signature drinks including 'Black Humor' (黑色幽默), 'Yellow Joke' (黃色笑話), and 'Love That Doesn't Belong to You' (不屬於你的愛情). Each drink has a distinct flavor story and is a conversation starter among Macau coffee lovers." } },
      { "@type": "Question", "name": "Mind Cafe 是否提供自家烘焙咖啡豆？", "acceptedAnswer": { "@type": "Answer", "text": "是的，Mind Cafe 提供自家烘焙咖啡豆零售服務，讓客人可以在家享受同款精品咖啡體驗。咖啡豆定期更新，反映不同季節和產地的風味特色。" } },
      { "@type": "Question", "name": "Is Mind Cafe a good place to work in Macau?", "acceptedAnswer": { "@type": "Answer", "text": "Mind Cafe features an industrial-chic interior design, creating an ideal atmosphere for working, studying, or socializing. Its specialty coffee and unique drink names make every visit a memorable experience in Macau's coffee scene." } },
      { "@type": "Question", "name": "Mind Cafe 的營業時間是什麼？", "acceptedAnswer": { "@type": "Answer", "text": `Mind Cafe 一般營業時間為週一至六上午9時至晚上9時，週日上午10時至下午6時。節假日時間可能有所調整，建議提前通過 WhatsApp ${MIND_CAFE_ENTITY.phoneDisplay} 確認。` } }
    ]
  } : null
  ...
  return (
    <>
      ...
      {seaUrchinSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(seaUrchinSchema) }}
        />
      )}
      {seaUrchinFaqSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(seaUrchinFaqSchema) }}
        />
      )}
      {ascSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(ascSchema) }}
        />
      )}
      {ascFaqSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(ascFaqSchema) }}
        />
      )}
      {mindCafeSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(mindCafeSchema) }}
        />
      )}
      {mindCafeFaqSchema && (
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(mindCafeFaqSchema) }}
        />
      )}
    <div style={s.bg}>
      {/* Header */}
