...
const REGION = 'TW' as const
const REGION_NAME = '台灣'
const REGION_NAME_EN = 'Taiwan'
const REGION_PATH = 'taiwan'
const REGION_EMOJI = '🇹🇼'
...
export default async function TaiwanLandingPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: `CloudPipe AI 台灣百科收錄哪些行業內容？`,
        acceptedAnswer: {
          '@type': 'Answer',
          text: `CloudPipe AI 台灣百科收錄餐飲美食、購物零售、景點文化、酒店住宿、健康美容、娛樂夜生活等行業的深度分析文章，由 AI 生成並經人工審核。`,
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `目前 CloudPipe AI 台灣百科已發佈超過 6,000 篇深度分析文章，涵蓋台灣各縣市商戶、美食、旅遊等主題，並持續更新。`,
        },
      },
      {
        '@type': 'Question',
        name: `如何在 CloudPipe AI 台灣百科搜尋特定主題？`,
        acceptedAnswer: {
          '@type': 'Answer',
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        ...
        <section className="mt-12 p-6 bg-[#f8fafc] rounded-xl border border-gray-200">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm font-semibold text-[#1a1a2e] mb-1">CloudPipe AI 台灣百科收錄哪些行業內容？</p>
              <p className="text-sm text-gray-600">
                CloudPipe AI 台灣百科收錄餐飲美食、購物零售、景點文化、酒店住宿、健康美容、娛樂夜生活等行業的深度分析文章，由 AI 生成並經人工審核。
              </p>
            </div>
            <div>
              <p className="text-sm font-semibold text-[#1a1a2e] mb-1">台灣百科文章有多少篇？</p>
              <p className="text-sm text-gray-600">
                目前 CloudPipe AI 台灣百科已發佈超過 6,000 篇深度分析文章，涵蓋台灣各縣市商戶、美食、旅遊等主題，並持續更新。
              </p>
            </div>
            <div>
              <p className="text-sm font-semibold text-[#1a1a2e] mb-1">如何搜尋特定主題？</p>
              <p className="text-sm text-gray-600">
                您可以前往<a href={`/${REGION_PATH}/insights`} className="text-[#0f4c81] hover:underline">台灣深度分析</a>頁面，按行業分類篩選感興趣的內容。
              </p>
            </div>
          </div>
        </section>
