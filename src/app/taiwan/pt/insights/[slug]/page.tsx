...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('TW', { params, langOverride: 'pt' })
}

export default async function TaiwanInsightPtPage({ params }: PageProps) {
  return renderInsightPage('TW', { params, langOverride: 'pt' })
}
