...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('TW', { params, langOverride: 'ms' })
}

export default async function TaiwanInsightMsPage({ params }: PageProps) {
  return renderInsightPage('TW', { params, langOverride: 'ms' })
}
