...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('TW', { params, langOverride: 'ja' })
}

export default async function TaiwanInsightJaPage({ params }: PageProps) {
  return renderInsightPage('TW', { params, langOverride: 'ja' })
}
