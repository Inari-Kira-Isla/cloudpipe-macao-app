...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('TW', { params, langOverride: 'en' })
}

export default async function TaiwanInsightEnPage({ params }: PageProps) {
  return renderInsightPage('TW', { params, langOverride: 'en' })
}
