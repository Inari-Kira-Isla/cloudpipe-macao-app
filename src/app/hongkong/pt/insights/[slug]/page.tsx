...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('HK', { params, langOverride: 'pt' })
}

export default async function HongkongInsightPtPage({ params }: PageProps) {
  return renderInsightPage('HK', { params, langOverride: 'pt' })
}
