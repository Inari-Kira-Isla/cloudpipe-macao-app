...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('HK', { params, langOverride: 'ja' })
}

export default async function HongkongInsightJaPage({ params }: PageProps) {
  return renderInsightPage('HK', { params, langOverride: 'ja' })
}
