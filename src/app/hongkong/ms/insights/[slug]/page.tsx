...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('HK', { params, langOverride: 'ms' })
}

export default async function HongkongInsightMsPage({ params }: PageProps) {
  return renderInsightPage('HK', { params, langOverride: 'ms' })
}
