...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('HK', { params, langOverride: 'en' })
}

export default async function HongkongInsightEnPage({ params }: PageProps) {
  return renderInsightPage('HK', { params, langOverride: 'en' })
}
