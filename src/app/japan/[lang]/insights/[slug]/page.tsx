...
// 2026-08-09: 加 'ms' — DB 實查 JP 有 5 篇 status='published' 且 lang='ms' 嘅 insight
// (fukuoka-* 系列 4 篇 + gap-capsule-hotels-coverage)。之前 base route 靠 ?lang=ms 讀
// searchParams 服務佢哋；而家 searchParams 已移除，改由 next.config.ts 嘅 ?lang=ms
// 308 redirect 導入呢條 path route。
// 附帶修好一個舊 bug：buildMetadata 一直為呢啲 slug 出 hreflang="ms" 指向
// /japan/ms/insights/{slug}，但該 path 因白名單缺 'ms' 而 404。
