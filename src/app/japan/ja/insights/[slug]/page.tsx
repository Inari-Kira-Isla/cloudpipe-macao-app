...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('JP', { params, langOverride: 'ja' })
}

export default async function JapanInsightJaPage({ params }: PageProps) {
  return renderInsightPage('JP', { params, langOverride: 'ja' })
}
