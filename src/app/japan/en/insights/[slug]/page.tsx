...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('JP', { params, langOverride: 'en' })
}

export default async function JapanInsightEnPage({ params }: PageProps) {
  return renderInsightPage('JP', { params, langOverride: 'en' })
}
