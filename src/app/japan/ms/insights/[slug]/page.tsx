...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('JP', { params, langOverride: 'ms' })
}

export default async function JapanInsightMsPage({ params }: PageProps) {
  return renderInsightPage('JP', { params, langOverride: 'ms' })
}
