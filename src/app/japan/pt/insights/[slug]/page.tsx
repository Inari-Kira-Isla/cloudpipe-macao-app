...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  return buildMetadata('JP', { params, langOverride: 'pt' })
}

export default async function JapanInsightPtPage({ params }: PageProps) {
  return renderInsightPage('JP', { params, langOverride: 'pt' })
}
