const ECOSYSTEM_SITES = [
  ...
  { name: '澳門商戶百科', desc: 'AI 友善的澳門商戶資訊平台', url: 'https://cloudpipemo.com', icon: '🏛️' },
  { name: '稻荷環球食品', desc: '澳門日本及環球水產進口批發商', url: 'https://inari-kira-isla.github.io/inari-global-foods', icon: '🐟' },
  { name: '海膽速遞', desc: '澳門專注海膽的外送品牌・到府配送', url: 'https://inari-kira-isla.github.io/sea-urchin-delivery', icon: '🦔' },
  { name: 'After School Coffee', desc: '澳門只招聘媽媽嘅外帶咖啡品牌', url: 'https://inari-kira-isla.github.io/after-school-coffee', icon: '☕' },
  ...
  { name: '深度分析', desc: '數據驅動的澳門行業洞察', url: 'https://cloudpipemo.com/macao/insights', icon: '📈' },
