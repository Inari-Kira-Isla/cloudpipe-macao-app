-- CloudNote Users Tier System - Migration
-- Run this to create the cloudnote_users table for the CloudNote subscription system
...
-- RLS Policies
DROP POLICY IF EXISTS "Users can read own profile" ON cloudnote_users;
CREATE POLICY "Users can read own profile" ON cloudnote_users
  FOR SELECT USING (auth.uid()::text = id::text);

DROP POLICY IF EXISTS "Service role can manage all" ON cloudnote_users;
