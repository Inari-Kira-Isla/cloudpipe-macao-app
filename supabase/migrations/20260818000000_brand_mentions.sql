-- Brand Mention Monitoring Table
-- Stores off-site brand mentions from social media, news, and forums

CREATE TABLE IF NOT EXISTS brand_mentions (
    id BIGSERIAL PRIMARY KEY,
    brand_slug TEXT NOT NULL,
    mention_type TEXT NOT NULL DEFAULT 'general' CHECK (mention_type IN ('general', 'social', 'news', 'forum')),
    title TEXT,
    url TEXT,
    snippet TEXT,
    source TEXT,
